...
export class Backend implements backendInterface {
    ...
    async submitReservation(arg0: string, arg1: string, arg2: Time, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitReservation(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
